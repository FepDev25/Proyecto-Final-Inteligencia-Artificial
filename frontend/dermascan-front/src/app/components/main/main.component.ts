...
export class MainComponent {
  ...
  totalCondicionesAnalizadas: number = 0;
  ...
  analyzeImage() {
    ...
    this.prediccionService.predecir(file).subscribe({
      next: (respuesta) => {
        ...
        // Guardar el total de condiciones analizadas
        this.totalCondicionesAnalizadas = respuesta.otras_posibles_condiciones.length;
        // Solo mostrar las 3 condiciones con mayor probabilidad
        this.otrasCondiciones = respuesta.otras_posibles_condiciones.slice(0, 3);
